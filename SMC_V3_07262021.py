...
class App(object):
    ...
    def isomer_search(self,ms2_ions,mass):
        ...
        for activation_type in range(0,len(ms2_ions),2):
            ...
            with open(filename,"a") as out_file:
                out_file.write("Be cautious when using this data: only mass differences and NOT ION TYPE are considered when searching.\n"
                               "Output format: fragment ion 1, fragment ion2, charge state, delta mass, ratio of frag ion 1 intensity to total\n")
        ...
        mb.showinfo("Run Completed", "The run has completed and generated 'Isomer Search' output file(s).")
